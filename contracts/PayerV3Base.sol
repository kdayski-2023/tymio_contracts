...
contract PayerV3Base {
    ...
    ISwapRouter02 public constant swapRouter =
        ISwapRouter02(0x2626664c2603336E57B271c5C0b26F421741e481); // Uniswap swap router
    uint24 public poolFee = 500; // Fee for liquidity pool usage, in basis points.
    ...
    address public constant wethAddress =
        0x4200000000000000000000000000000000000006; // Address of Wrapped ETH (WETH) contract.
            ...
            for (uint256 j; j < acceptableTokensArrayLength; ) {
                if (
                    ...
                    ISwapRouter02.ExactInputSingleParams
                        memory swapParams = ISwapRouter02.ExactInputSingleParams({
