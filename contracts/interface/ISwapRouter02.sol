...
interface ISwapRouter02 is IUniswapV3SwapCallback {
    ...
    /// @notice Swaps as little as possible of one token for exactOut of another token
    ...
    /// @notice Swaps as little as possible of one token for exactOut of another along the specified path (reversed)
